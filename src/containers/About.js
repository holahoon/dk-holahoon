  ...
  const aboutMeIntroduction =
    language === "en" ? (
      <div className='about__english-introduction'>
        ...
        <p>
          My frontend career started at a digital marketing agency located in
          Duluth, GA. There, I've collaborate with other developers as well as
          QAs and PMs and learned the importance of active communication. In my
          spare times, I've also continued to learn and worked on side projects
          with a designer to strenghten my weaknesses and find improvements.
        </p>
        <p>
          ...
          day when I was completely mesmerized by the beauty of seeing my very
          own written code working on the browser
        </p>
        <p>
          Well, today marks the {days}
          <sup>{ordinal}</sup> day since I officially became a frontend
          developer and I don't plan on just staying as a frontend developer,
          but I dream of growing as a "damn good developer". 'Til that day
          comes, hustle n' code.
        </p>
        <p>
          ...
          of my youth and teenage years, Seoul, Republic of Korea. <br />
          But I'm sure we can still be in touch!
        </p>
      </div>
    ) : (
      <div className='about__korean-introduction'>
        ...
        <p>
          많은 개발자처럼 저도 처음 "hello world" 를 콘솔에 출력한 날이
          기억납니다. 역시 예상하신대로 그날 제가 직접 작성한 코드가
          브라우저에서 작동될때의 그 희열감과 신기함은 이루 말할수가 없었습니다.
        </p>
        <p>
          오늘이 공식적으로 프론트엔드 개발자가 된지 정확히 {days}일이
          되었습니다. 그러나 프론트엔드 개발자에서 끝내는 것이 아닌 점진적으로
          성장하여 영향력 있는 개발자가 되는 그날까지 hustle 'n code.
        </p>
        <p>
          지금은 전세계적으로 펜더믹이라는 안정적이지 않는 시기에 큰 위험을
          무릅쓰고 결정을 하여 한국에서 개발자의 꿈을 이어가고자 귀국
          하였습니다. <br />
          기회가 된다면 함께 성장하고 싶습니다.
        </p>
      </div>
    );
